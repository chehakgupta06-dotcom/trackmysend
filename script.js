...
(function () {
  ...
  function showPage(name) {
    ...
    const currentLink = document.querySelector(`.nav-links a[data-page="${name}"]`);
  ...
  // open correct page on load (from hash) or default to dashboard
  ...
  window.addEventListener("hashchange", () => {
    ...
    if (document.getElementById(name)) showPage(name);
  });
})();
